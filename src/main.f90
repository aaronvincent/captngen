...
! Variables used for original qv scaled capt'n
    ...
    double precision :: mx, sigma_0, capped, maxcapture, rho0, usun, u0, vesc, capture_maximum
...
! Use the original qv scaling capture calculation
    do j = 1,7
        ...
        do i = 1,10
            ...
            print*
            call capture_rate_qv(mx, sigma_0, num_isotopes, nq(j), nv(j), spin_dependency, capped)
