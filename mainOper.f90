...
PROGRAM GENCAP
	...
	call populate_array(1.65d-8, 15, 0)
	...
	open(55,file = "testingCatena/Oper_factor_of_two_data/factortwotest_oper_c15-0_alliso-gs98.dat")!"testingCatena/Oper_data/captest_oper_c1-0_alliso-gs98.dat")
	do i=1,21
