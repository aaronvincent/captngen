...
def plottogether_csv(couplingConstant, title="Catena Plot", savefigname=None):
	...
	# filename = "Oper_Usun_update/captest_oper_"+couplingConstant+"_alliso-ags05.dat"
	# filename = "Oper_Usun_update/captest_oper_"+couplingConstant+"_alliso-agss09.dat"
	# filename = "Oper_Usun_update/captest_oper_"+couplingConstant+"_alliso-agss09ph.dat"
	# filename = "Oper_Usun_update/captest_oper_"+couplingConstant+"_alliso-gs98.dat"

	filename = "Oper_W_update/captest_oper_"+couplingConstant+"_alliso-ags05.dat"
	# filename = "Oper_W_update/captest_oper_"+couplingConstant+"_alliso-agss09.dat"
	# filename = "Oper_W_update/captest_oper_"+couplingConstant+"_alliso-agss09ph.dat"
	# filename = "Oper_W_update/captest_oper_"+couplingConstant+"_alliso-gs98.dat"
...
for c in couplingConstants:
	...
	# plottogether_csv(c, "Comparison plot of "+c+" ags05", "Comparison_Usun_Plots/"+c+"_ags05_comparison.pdf")
	# plottogether_csv(c, "Comparison plot of "+c+" agss09", "Comparison_Usun_Plots/"+c+"_agss09_comparison.pdf")
	# plottogether_csv(c, "Comparison plot of "+c+" agss09ph", "Comparison_Usun_Plots/"+c+"_agss09ph_comparison.pdf")
	# plottogether_csv(c, "Comparison plot of "+c+" gs98", "Comparison_Usun_Plots/"+c+"_gs98_comparison.pdf")

	plottogether_csv(c, "Comparison plot of "+c+" ags05", "Comparison_W_Plots/"+c+"_ags05_comparison.pdf")
	# plottogether_csv(c, "Comparison plot of "+c+" agss09", "Comparison_W_Plots/"+c+"_agss09_comparison.pdf")
	# plottogether_csv(c, "Comparison plot of "+c+" agss09ph", "Comparison_W_Plots/"+c+"_agss09ph_comparison.pdf")
	# plottogether_csv(c, "Comparison plot of "+c+" gs98", "Comparison_W_Plots/"+c+"_gs98_comparison.pdf")
